...
#Such as Min, Max, Mean, Median, and Quartiles.
#Task: Complete the comment above
summary(Damaris_mydata)
...
#This brings 2 new "Newwomen"data in the environment, one is called"NewWomen" and the other "NewWomen1".
...
#TASK:Change the arguments for the geom point and see what happens to the plot
ggplot(NewWomen, aes(x=height, y=weight)) + 
  geom_point(shape =15 , colour = "black", fill = "white", size = 7, stroke = 4)
